...
<pre># sudo curl -OL https://github.com/erbarratt/savtocsv/archive/refs/tags/savtocsv.1.6.tar.gz</pre>

or

<pre># sudo wget https://github.com/erbarratt/savtocsv/archive/refs/tags/savtocsv.1.6.tar.gz</pre>

<pre># sudo tar -xvf savtocsv.1.6.tar.gz</pre>
<pre># cd savtocsv-savtocsv.1.6</pre>
<pre># sudo make</pre>
