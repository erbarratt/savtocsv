...
<pre># sudo curl -OL https://github.com/erbarratt/savtocsv/archive/refs/tags/savtocsv.1.4.tar.gz</pre>
<pre># sudo tar -xvf savtocsv.1.4.tar.gz</pre>
<pre># cd savtocsv-savtocsv.1.4</pre>
<pre># sudo make</pre>
